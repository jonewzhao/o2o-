...
def get_processed_data():
    dataset1 = pd.read_csv('train/ProcessDataSet1.csv')
    dataset2 = pd.read_csv('train/ProcessDataSet2.csv')
    dataset3 = pd.read_csv('train/ProcessDataSet3.csv')
...
def train_xgb(dataset12, dataset3):
    ...
    model.save_model('train/xgbmodel')
    params['predictor'] = 'cpu_predictor'
    model = xgb.Booster(params)
    model.load_model('train/xgbmodel')
    ...
    dataset3_predict.to_csv("train/xgb_preds.csv", index=None, header=None)
